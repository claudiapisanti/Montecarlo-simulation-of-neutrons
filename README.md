...
5. Line 5. --> Geometrical distribution of the source. Type **PUNT** fro pointlike source, **EST** for extended source and **SPH** for spherical source
...
6. Line 6. --> Other parameters for the geometric distribution of the source.
	...
	*example 1:* point source in pos x = 0, y = 0, z = 6.
	...
	- if line 5 is EST, type the probability of having a certain distribution. For the lefend of faces numbers see the picture below
