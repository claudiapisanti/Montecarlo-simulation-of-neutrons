"""
This code has been provided only to understand how cross section of polyvinyltoluene has been obtained. 
It is not necessery to run it before montecarlo simulation. 
All useful energy and cross section information has been already provided in file "cs.txt".
"""

import pandas as pd
import numpy as np

# open cross sctions data (provided from JANIS)
